//
//  calenderItemTableViewController.m
...
#import "calenderItemTableViewController.h"
...
@interface calenderItemTableViewController ()
...
@implementation calenderItemTableViewController
...
- (void)viewDidLoad
{
    ...
    NSMutableDictionary *itemTwo = [@{ kTitleKey : @"Lesson date",
                                       kDateKey : _dayDate } mutableCopy];
    NSMutableDictionary *itemThree = [@{ kTitleKey : @"Duration",
